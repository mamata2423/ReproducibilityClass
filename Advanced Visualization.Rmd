...
boxplot <- ggplot(data = datum, aes(x = Treatment, y = DON, color = Cultivar)) + #defining aesthetics x as Treatment and y as DON
  geom_boxplot(position = position_dodge(), alpha = 0.6) +  #creating box plot without overlap and setting transparency of outlier as 0.6
  geom_point(position = position_jitterdodge(), alpha = 0.6) + #filling the box plot with data points without overlap and setting transparency of the data points as 0.6
  scale_color_manual(values = c(cbbPalette[[4]], cbbPalette[[7]])) + #setting colors of boxplot and data points manually
...
boxplot1 <- ggplot(data = datum, aes(x = Treatment, y = DON, color = Cultivar)) +  #defining aesthetics x as Treatment and y as DON
  geom_boxplot(position = position_dodge(), alpha = 0.6) + #creating box plot without overlap and setting transparency of outlier as 0.6
  geom_point(position = position_jitterdodge(), alpha = 0.6) + #filling the box plot with data points without overlap and setting transparency of the data points as 0.6
  scale_color_manual(values = c(cbbPalette[[4]], cbbPalette[[7]])) + #setting colors of boxplot and data points manually
  xlab("") + #labelling x axis
...
```{r}
datum$Treatment <- factor(datum$Treatment, levels = c("NTC", "Fg", "Fg + 37", "Fg + 40", "Fg + 70")) #changing the order of the treatments as mentioned
boxplot_15ADON <- ggplot(data = datum, aes(x = Treatment, y = X15ADON, color = Cultivar)) + #defining aesthetics x as Treatment and y as DON
  geom_boxplot(position = position_dodge(), alpha = 0.6) + #creating box plot without overlap and setting transparency of outlier as 0.6
  geom_point(position = position_jitterdodge(), alpha = 0.6) + #filling the box plot with data points without overlap and setting transparency of the data points as 0.6
   scale_color_manual(values = c(cbbPalette[[4]], cbbPalette[[7]])) + #setting colors of boxplot and data points manually
  xlab("") + #labelling x axis
...
boxplot_massperseed <- ggplot(data = datum, aes(x = Treatment, y = MassperSeed_mg, color = Cultivar)) + #defining aesthetics x as Treatment and y as DON
  geom_boxplot(position = position_dodge(), alpha = 0.6) + #creating box plot without overlap and setting transparency of outlier as 0.6
  geom_point(position = position_jitterdodge(), alpha = 0.6) + #filling the box plot with data points without overlap and setting transparency of the data points as 0.6
   scale_color_manual(values = c(cbbPalette[[4]], cbbPalette[[7]])) + #setting colors of boxplot and data points manually
  xlab("") + #labelling x axis
...
```
 ...
 The common.legend option within ggarrange function let us combine the legends of all the plots that have been combined using ggarrange function.
